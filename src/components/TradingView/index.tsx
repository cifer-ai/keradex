...
export const TVChartContainer = () => {
  ...
  React.useEffect(() => {
    ...
    const widgetOptions: ChartingLibraryWidgetOptions = {
      ...
      overrides: {
        ...savedProperties,
        'mainSeriesProperties.candleStyle.upColor': '#53c2a3',
        'mainSeriesProperties.candleStyle.downColor': '#eb4476',
        // 'mainSeriesProperties.candleStyle.borderColor': '#378658',
        'mainSeriesProperties.candleStyle.borderUpColor': '#53c2a3',
        'mainSeriesProperties.candleStyle.borderDownColor': '#eb4476',
        'mainSeriesProperties.candleStyle.wickUpColor': '#53c2a3',
        'mainSeriesProperties.candleStyle.wickDownColor': '#eb4476',
      },
      // @ts-ignore
