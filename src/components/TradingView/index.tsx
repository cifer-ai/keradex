...
export const TVChartContainer = () => {
  ...
  React.useEffect(() => {
    ...
    const widgetOptions: ChartingLibraryWidgetOptions = {
      ...
      overrides: {
        ...savedProperties,
        'mainSeriesProperties.candleStyle.upColor': '#3FD49D',
        'mainSeriesProperties.candleStyle.downColor': '#D13758',
        // 'mainSeriesProperties.candleStyle.borderColor': '#378658',
        'mainSeriesProperties.candleStyle.borderUpColor': '#3FD49D',
        'mainSeriesProperties.candleStyle.borderDownColor': '#D13758',
        'mainSeriesProperties.candleStyle.wickUpColor': '#3FD49D',
        'mainSeriesProperties.candleStyle.wickDownColor': '#D13758',
      },
      // @ts-ignore
